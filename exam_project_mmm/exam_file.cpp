...
int main() {
    ...
    for (int round = 1; round <= rounds; round++) {
        ...
        do {
            ...
            if (playerChoice >= 1 && playerChoice <= 3) {
                ...
                switch (phraseError) {
                case 1: cout << "Dummy man...\n"; break;
                case 2: cout << "What are you trying to achieve?\n"; break;
                case 3: cout << "Who are the rules for?\n"; break;
                case 4: cout << "You're not silly, are you?\n"; break;
                case 5: cout << "The mistake is behind you)\n"; break;
                }
            }
        } while (!validInput);
    ...
    if (wins + losses + draws > 0) {
        cout << "\n\033[35m Thanks for playing!\033[0m" << endl;
    }
    else {
